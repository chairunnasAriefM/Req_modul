                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form>
                                                ...
                                                <div class="mb-3">
                                                    <label for="id_anggota_request<?= $modul->modul_id ?>" class="form-label">ID Anggota Request</label>
                                                    <input type="text" class="form-control" id="id_anggota_request<?= $modul->modul_id ?>" value="<?= $modul->id_anggota_request ?>" readonly>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="judul_modul<?= $modul->modul_id ?>" class="form-label">Judul Modul</label>
                                                    <input type="text" class="form-control" id="judul_modul<?= $modul->modul_id ?>" value="<?= $modul->judul_modul ?>" readonly>
                                                </div>
                                                ...
                                                <?php endif; ?>
                                                <div class="mb-3">
                                                    <label for="jumlah_cetak<?= $modul->modul_id ?>" class="form-label">Jumlah Cetak</label>
                                                    <input type="text" class="form-control" id="jumlah_cetak<?= $modul->modul_id ?>" value="<?= $modul->jumlah_cetak ?>" readonly>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="status<?= $modul->modul_id ?>" class="form-label">Status</label>
                                                    <input type="text" class="form-control" id="status<?= $modul->modul_id ?>" value="<?= $modul->status ?>" readonly>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="tanggal_request<?= $modul->modul_id ?>" class="form-label">Tanggal Request</label>
                                                    <input type="text" class="form-control" id="tanggal_request<?= $modul->modul_id ?>" value="<?= $modul->tanggal_request ?>" readonly>
                                                </div>
                                            </form>
                                        </div>
